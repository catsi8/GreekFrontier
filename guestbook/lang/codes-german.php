...
<CENTER>
  <table width="95%" border="0" cellspacing="1" cellpadding="0">
    ...
    <tr> 
      <td> 
        <p><font color="#000000">Smilies sind kleine Grafiken, die ein Gefl 
          f Ihren Beitrag oder einen Teil Ihres Beitrages darstellen sollen. 
          Manches l魠t sich durch die Verwendung eines Smilies besser darstellen! 
    ...
    <tr> 
      <td> 
        <p><font color="#000000">AG Code ist eine Sammlung von HTML-Befehlen. 
          Er erlaubt Ihnen, bestimmte Funktionen hinzuzufen oder Ihren Beitrag 
          zu ver鄚dern, wozu Sie normalerweise HTML-Befelhe einsetzen msten. 
          Sie k霵nen AG Code verwenden, selbst wenn die HTML-Funktion f das 
          G&auml;stebuch abgeschaltet ist. Sie sollten AG Code anstelle von HTML 
          verwenden, selbst wenn die HTML-Funktion f das G&auml;stebuch eingeschaltet 
          ist, da wenig Befehle verwendet werden und er sicherer zu benutzen ist 
          (falscher Syntax kann zu wenigeren Problemen fren). </font> 
        ...
        <TABLE border=0 cellPadding=4 cellSpacing=1 width="100%">
          ...
          <TR bgColor=#CCCCCC> 
            <TD bgcolor="#FFFFFF">Ist AG Code eingeschaltet, brauchen Sie nicht 
              l鄚ger den [URL] Code benutzen, um Hyperlinks zu erstellen. Schreiben 
              ...
              <UL>
                ...
                <LI><FONT color=#800000>www.IhreURL.com </FONT>Sie k&ouml;nnen 
                  ...
                  msen Sie die komplette Adresse mit "http://" angeben. Die 
                  Autolink-Funktion k霵nen Sie auch f https und ftp URL's verwenden 
                  (wenn AG Code eingeschaltet ist). <BR>
              </UL>
              <ul>
                Sie k霵nen jetzt richtige Links mit dem [url] Code erstellen. 
              ...
              <UL>
                <LI> 
                  ...
                  <P>In diesem Beispiel generiert der AG Code automatisch einen 
                    ...
                    Klick, wird der Link in einem neuen Fenster ge鐪fnet. Beachten 
          ...
          <TR bgColor=#CCCCCC> 
            <TD bgcolor="#FFFFFF">Sie k霵nen Kursiv- oder Fettschrift verwenden, 
              indem Sie den Text zwischen den AG Code einfen [b] [/b] oder [i] 
              [/i]. 
          ...
          <TR bgColor=#006666> 
            <TD bgcolor="#0099CC"><b><font color="#FFFFFF">Einfen von Bildern</font></b></TD>
          </TR>
          <TR bgColor=#CCCCCC> 
            <TD bgcolor="#FFFFFF">Um eine Grafik in Ihren Beitrag einzufen, 
              k霵nen Sie die URL der Grafik innerhalb des AG Code verwenden (AG 
              ...
              <P>In diesem Beispiel macht der AG Code die Grafik in Ihrem Beitrag 
                ...
                NOTWENDIG f den <font color="#FF0000">[img]</font> Code.</P>
            </TD>
          </TR>
          </TBODY> 
        </TABLE>
  ...
  <table width="95%" border="0" cellspacing="1" cellpadding="4" align="center">
    <tr bgcolor="#CCCCCC"> 
      <td bgcolor="#FFFFFF"><font color=#800000><u>Hinweise:</u></font><br>
        Sie dfen HTML und UBB Code nicht gleichzeitig verwenden, um die gleiche 
        Funktion auszufren. Weiterhin brauchen Sie beim AG Code nicht auf Gro?/Kleinschreibung 
        zu achten (Sie k霵nen <font color="#FF0000">[URL]</font> oder <font color="#FF0000">[url]</font> 
        verwenden). <br>
        <br>
        ...
        - der End-Code enth鄟t jeweils einen Schr輍strich (<font color="#FF0000">[/email]</font>) 
      </td>
    </tr>
  </table>
</CENTER>
